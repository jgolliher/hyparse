...
class TestRankTimes:
    ...
    def test_custom_group_columns(self):
        ...
        result = rank_times(
            df, group_cols=["event_no", "gender"], rank_col="seed_time", out_col="rank"
        )
    ...
    def test_missing_rank_column_raises_error(self):
        ...
        df = pd.DataFrame({"event_no": [1, 1], "other_col": [50.0, 48.0]})
    ...
    def test_missing_group_column_raises_error(self):
        ...
        df = pd.DataFrame({"other_col": [1, 1], "seed_time": [50.0, 48.0]})
    ...
    def test_single_row(self):
        ...
        df = pd.DataFrame({"event_no": [1], "seed_time": [50.0]})
        result = rank_times(df, rank_col="seed_time")
    ...
    def test_ascending_order(self):
        ...
        df = pd.DataFrame({"event_no": [1, 1, 1], "seed_time": [100.0, 50.0, 75.0]})
        result = rank_times(df, rank_col="seed_time")
